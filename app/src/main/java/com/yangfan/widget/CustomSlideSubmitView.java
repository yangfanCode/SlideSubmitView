...
import com.yangfan.slidesubmitview.R;


/**
 * CustomSlideSubmitView
 * create by yangfan
 * nrainyseason@163.com
 **/
public class CustomSlideSubmitView extends RelativeLayout {

    private static final String TAG="CustomSlideSubmitView";
    ...
    public CustomSlideSubmitView(Context mContext) {
        super(mContext);
        this.mContext = mContext;
        initView();
    }

    public CustomSlideSubmitView(Context mContext, AttributeSet attrs) {
    ...
    public CustomSlideSubmitView(Context mContext, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView() {
        ...
        rl_slide.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                DISTANCE_LIMIT= (int) (CustomSlideSubmitView.this.getWidth()*THRESHOLD);//默认阈值是控件宽度的一半
